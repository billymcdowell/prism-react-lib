import{j as s}from"./jsx-runtime-u17CrQMm.js";import{T as o}from"./textarea-WFWn170-.js";import{L as l}from"./label-CkLFC7Dz.js";const d={title:"UI/Textarea",component:o,argTypes:{placeholder:{control:"text"},disabled:{control:"boolean"}}},e={args:{placeholder:"Type your message here."}},r={render:t=>s.jsxs("div",{className:"grid w-full gap-1.5",children:[s.jsx(l,{htmlFor:"message",children:"Your message"}),s.jsx(o,{placeholder:"Type your message here.",id:"message",...t})]})},a={args:{disabled:!0,placeholder:"Disabled"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
